# Archived v1 contributor instructions

Status: historical evidence; not active instructions  
Archived: 2026-08-02

This file is the verbatim contributor document found in the imported game
repository, apart from this archive notice. It assumes a parent workspace with
sibling `field_game/` and `docs/field-framework/` directories and cites five
documents that were never tracked and could not be recovered. See
[`../LEGACY_CONTRACT_STATUS.md`](../LEGACY_CONTRACT_STATUS.md).
